...
Este archivo guarda aprendizaje para futuras publicaciones.

## Lecciones

- Mantener profundidad.
- No dejar secciones pobres.
...
- Nueva publicacion: +40.
- Ampliacion correcta: +25.
- Correccion editorial importante: +20.
...
- 0: aprendiz con memoria.
- 300: redactor de cancha.
- 700: editor con oficio.
- 1200: capitan editorial.
- 2000: viejo capitan del barco.
